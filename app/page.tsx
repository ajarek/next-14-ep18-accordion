  ...
  return (
    <main className='max-w-[1440px] mx-auto flex min-h-screen flex-col items-center justify-start  bg-violet-300'>
      ...
      <Accordion
        type='single'
        collapsible
        className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-[500px] max-h-[500px] min-w-[320px] flex flex-col justify-evenly rounded-3xl  bg-slate-200 p-4'
      >
        ...
        <AccordionItem value='item-4'>
          <AccordionTrigger>
            How can I get help if I'm stuck on a FM challenge?
          </AccordionTrigger>
          <AccordionContent>
